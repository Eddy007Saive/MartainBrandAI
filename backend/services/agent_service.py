...
REGLES_ANTI_IA = (
    ...
    "have it, either phrase it qualitatively (\"la plupart\", \"en quelques semaines\") or leave a visible "
    "bracketed placeholder in the OUTPUT LANGUAGE (e.g. [chiffre à compléter]) for the user to fill. "
    "Never state a precise figure you cannot source.\n"
